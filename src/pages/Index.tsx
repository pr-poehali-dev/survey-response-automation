        ...
        {!showResult ? (
          <div className="animate-fade-in">
            <div className="text-center mb-12">
              <h1 className="font-heading sm:text-5xl font-bold text-gray-900 mb-3 text-xs">Оценить возможность постановки на учет граждан в качестве нуждающихся в жилых помещениях, предоставляемых 
